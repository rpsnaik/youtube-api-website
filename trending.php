...
<body>
  ...
  <section style="padding-bottom: 0px;"   class="s-pageheader--home">
        ...
        <header class="header" style="margin: 0px;padding: 0px;">
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="current"><a href="trending.php" title="">Trending</a></li>
           ...
           <div class="middle-md middle-sm middle-xs middle-lg">
             <div class="">
                <p id="ress"  style="color: #fff; font-size: 1.5em; padding: 0px;margin: 0px;text-align: center;">Search here for Anything</p>
