  ...
  <section style="padding-bottom: 0px;"   class="s-pageheader--home">
        ...
        <header class="header" style="margin: 0px;padding: 0px;">
            <div class="header__content row">
                ...
                <div class="header__search">
                    ...
                    <form role="search" method="GET" class="header__search-form" id="youtubesearch" action="./search.php">
                            ...
                            <span class="hide-content">Search for Anything :</span>
           ...
           <div class="row middle-md middle-sm middle-xs middle-lg">
             <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6 center-md center-xs center-lg center-sm">
                <p id="ress"  style="color: #fff; font-size: 1.5em; padding: 0px;margin: 0px;text-align: center;">Getting info</p>
            <div style="color: #fff;border-radius: 0.6em;" id="results"><div style="text-align: center;" class="loader"></div> <span style="text-align: center;">Loading ... </span></div>
             </div>
           </div>
       ...
       <script>
            ...
            setInterval(function(){
               ...
               $('#ress').html("Popular <?php echo $name ?> On Web");
