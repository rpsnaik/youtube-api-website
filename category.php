  ...
  <section style="padding-bottom: 0px;"   class="s-pageheader--home">
        ...
        <header class="header" style="margin: 0px;padding: 0px;">
           ...
           <div class="middle-md middle-sm middle-xs middle-lg">
             <div class="">
                <p id="ress"  style="color: #fff; padding: 0px; font-size: 1.5em; margin: 0px;text-transform: capitalize;text-align: center;"><?php echo($name) ?></p>
              
            <div style="color: #fff; font-family: 'Open Sans', sans-serif;border-radius: 0.6em;" id="results"><div style="text-align: center; " class="loader"></div></div>
             </div>
           </div>
